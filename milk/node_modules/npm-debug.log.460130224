...
1 verbose cli [ '/usr/local/bin/node', '/usr/local/bin/npm', 'ls', '--depth=0' ]
...
6 verbose cwd /Users/willsumner/Desktop/Code-Related-Files/cordova-stuff/NICU-Milk-App/milk/node_modules
7 error Darwin 18.0.0
8 error argv "/usr/local/bin/node" "/usr/local/bin/npm" "ls" "--depth=0"
